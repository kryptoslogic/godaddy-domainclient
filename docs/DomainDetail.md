...
**Verifications** | [***VerificationsDomain**](VerificationsDomain.md) | Progress and status for each of the verification processes requested for this domain | [optional] [default to null]
